...
export const builtinMCPServers: MCPServer[] = [
  {
    id: nanoid(),
    name: '@tutu/mcp-auto-install',
    description: '自动安装 MCP 服务（测试版）https://docs.tutu-ai.com/advanced-basic/mcp/auto-install',
    type: 'stdio',
    command: 'npx',
